...
const Prayer: React.FC = () => {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // EmailJS removed — simulate submission and success state for now.
    try {
      setLoading(true);
    ...
    <div className={styles["prayer"]}>
      <div className={styles["prayer__heading-wrapper"]}>
        ...
        <div className={styles["prayer__form-image-mobile"]}>
          <Image
            src={
              "https://kdijhjnkxkrfjlyavcoe.supabase.co/storage/v1/object/public/Gateway%20Cathedral/photos/christian-life-crisis-prayer-god.jpg"
            }
            fill
            loading="lazy"
            alt="A praying woman"
